...
//        personRepository.save(new Person("Azamat", "Abuov", LocalDate.of(1997, 12, 22), departments.get(2), documents.get(3)));
//        personRepository.save(new Person("Dmitrii", "Evseev", LocalDate.of(1998, 11, 9), departments.get(0), documents.get(4)));
